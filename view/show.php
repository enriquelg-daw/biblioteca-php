<?php //muestra todos los datos de un registro
...
<div class="pb-3">
    <a href="index.view.php" class="btn btn-primary">Regresar</a>
...
<table class="table container-fluid">
    ...
    <tbody>
        <tr>
            ...
            <td scope="col"><?= $date["autor"]?></td>
            <td scope="col"><?= $date["anyo_edicion"]?></td>
